...
public class CombatStatsMenu extends Menu {
    ...
    private void displayStats() {
        ...
        sb.append("Name:\t" + current_player.getName());
        sb.append("\t\t\t\tName:\t" + next_player.getName() + "\n");
        ...
        sb.append("Weapon:\t" + current_player.getWeapon());
        sb.append("\t\t\t\tWeapon:\t" + next_player.getWeapon() + "\n");
